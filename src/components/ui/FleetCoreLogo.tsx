...
interface FleetCoreLogoProps {
  className?: string;
  variant?: 'light' | 'dark';
}

export const FleetCoreLogo: React.FC<FleetCoreLogoProps> = ({ 
  className,
  variant = 'light'
}) => {
  ...
  return (
    <svg 
      ...
      className={cn('w-full h-auto max-w-[110px] sm:max-w-[120px] lg:max-w-[110px] transition-all duration-300 opacity-90 hover:opacity-100', className)}
      style={{
        minWidth: '110px',
        minHeight: '22px'
      }}
    >
      <defs>
        {variant === 'dark' ? (
          ...
          <>
            <linearGradient id={iconGradientId} x1="222.64" y1="574.43" x2="297.1" y2="481.15" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#0ea5e9"/>
              <stop offset="1" stopColor="#6ee7b7"/>
            </linearGradient>
            <linearGradient id={`${iconGradientId}-2`} x1="237.37" y1="586.18" x2="311.82" y2="492.9">
              <stop offset="0" stopColor="#0ea5e9"/>
              <stop offset="1" stopColor="#6ee7b7"/>
            </linearGradient>
            <linearGradient id={`${iconGradientId}-3`} x1="209.31" y1="563.78" x2="283.77" y2="470.51">
              <stop offset="0" stopColor="#0ea5e9"/>
              <stop offset="1" stopColor="#6ee7b7"/>
            </linearGradient>
          </>
        ) : (
          // Original beautiful gradient for light backgrounds
          <>
            <linearGradient id={iconGradientId} x1="222.64" y1="574.43" x2="297.1" y2="481.15" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#005e98"/>
              <stop offset="1" stopColor="#5bd8b5"/>
            </linearGradient>
            <linearGradient id={`${iconGradientId}-2`} x1="237.37" y1="586.18" x2="311.82" y2="492.9">
              <stop offset="0" stopColor="#005e98"/>
              <stop offset="1" stopColor="#5bd8b5"/>
