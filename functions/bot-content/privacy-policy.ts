...
<head>
  ...
  <title>SeaCore Privacy Policy - Data Protection & GDPR Compliance</title>
  <meta name="description" content="SeaCore privacy policy: GDPR compliant, organization-based data isolation, Row-Level Security, data encryption, and comprehensive audit trails.">
...
<body>
  ...
  <p>SeaCore ("we", "our", "us") is committed to protecting the privacy and security of your personal and operational data. This Privacy Policy explains how we collect, use, store, and protect data when you use the SeaCore Maritime Navigator platform.</p>
  ...
  <p>SeaCore is an enterprise maritime platform not intended for use by individuals under 18 years of age. We do not knowingly collect data from children.</p>
...
export { generatePrivacyPolicyContent };
