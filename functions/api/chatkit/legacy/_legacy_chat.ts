...
// DYNAMIC MODEL SELECTOR - Cost & Speed Optimization
...
// CONTENT ANALYSIS - Quick scan to check if sources answer the question
...
// SMART VERIFICATION DECISION - Determine if deep verification is needed
...
**Remember:** You can provide general maritime expertise, but specific entity queries require research mode.` },
    ...
    // Add Chain-of-Thought prompting for non-reasoning models
